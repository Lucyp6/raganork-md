...
if (!(process.env.SESSION || process.env.SESSION_ID)) throw new Error("Raganork~84fae0b0f0f9e0249ca2b538a4f6bb0a:67494f4e612f56547a6a553d")
module.exports = {
    VERSION: 'v4.0.0',
    ...
    HEROKU: {
        ...
        API_KEY: process.env.HEROKU_API_KEY || 'HRKU-20583756-1a26-490f-8c99-ad8b1b0dcb0b',
        APP_NAME: process.env.HEROKU_APP_NAME || 'great17'
    },
    DATABASE_URL: DATABASE_URL,
    DATABASE: DATABASE_URL === './bot.db' ? new Sequelize({ dialect: "sqlite", storage: DATABASE_URL, logging: DEBUG }) : new Sequelize(DATABASE_URL, { dialectOptions: { ssl: { require: true, rejectUnauthorized: false } }, logging: DEBUG }),
    SUDO: process.env.SUDO || "3",
